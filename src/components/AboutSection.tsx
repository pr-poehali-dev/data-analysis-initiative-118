      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            ИТМВЕБ создаёт эстетичные, быстрые и независимые сайты для роста бизнеса. Миссия студии — дать каждому предпринимателю профессиональный цифровой инструмент без барьера в виде стоимости разработки.
          </p>
        </div>
